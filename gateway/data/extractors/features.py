...
AUTO_ARTIFACT_DIR = PATHS.project_root / "autoencoder" / "data" / "artifacts"
DOS_CNN_ARTIFACT_DIR = PATHS.project_root / "dosdet" / "artifacts"
ARP_CNN_ARTIFACT_DIR = PATHS.project_root / "arpdet" / "artifacts"
DOS_LSTM_MODEL_DIR = PATHS.project_root / "Neural_LSTM" / "models"
ARP_LSTM_MODEL_DIR = PATHS.project_root / "ARP_LSTM" / "models"
DOS_LSTM_CONFIG_PATH = PATHS.project_root / "Neural_LSTM" / "configs" / "config.yaml"
ARP_LSTM_CONFIG_PATH = PATHS.project_root / "ARP_LSTM" / "configs" / "config.yaml"
DOS_CONFIG_PATH = PATHS.project_root / "dosdet" / "config.yaml"
ARP_CONFIG_PATH = PATHS.project_root / "arpdet" / "config.yaml"
