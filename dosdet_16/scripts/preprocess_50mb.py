...
def main():
    parser = argparse.ArgumentParser(description="Preprocess PCAP files with a 50MB limit per file (dosdet_16).")
    ...
    # Resolve files
    # The dosdet preprocess function calculates glob itself from the string
