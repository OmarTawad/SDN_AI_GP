...
class WindowDataset(Dataset):
    ...
    def __init__(
        ...
        self.S = stride_sec
        self.M = micro_bins
        self.top_ports = top_k_udp_ports
        self.for_training = for_training
        self.aug = augment or {}
        self.ssdp_v4 = ssdp_multicast_v4
        self.ssdp_v6 = ssdp_multicast_v6
    ...
    def _materialize_index(self):
        for i, p in enumerate(self.files):
            ...
            rows = list(iter_rows_from_pcap(p, self.ssdp_v4, self.ssdp_v6))
    ...
    def __getitem__(self, idx: int):
        ...
        if self.for_training and win_rows:
            ...
            if random.random() < self.aug.get("benign_overlay_prob", 0.0):
                ...
                if normals:
                    ...
                    q_rows = list(iter_rows_from_pcap(q, self.ssdp_v4, self.ssdp_v6))
        ...
        # features
        seq, extras = compute_sequence_features(win_rows, bins, self.M, self.top_ports)
        static_vec, static_names, snaps = compute_static_features(win_rows, self.M, extras["per_bin_total_pkts"], self.top_ports, self.W)
