...
def main() -> None:
    ...
    if num_windows == 1:
        result = infer_first_window(
            pcap_path, cfg, model, scaler, slimmer, meta, T, tau, window_sec, micro_bins, device, use_amp
        )
        ...
        windows = infer_windows(
            pcap_path, cfg, model, scaler, slimmer, meta, T, tau, window_sec, micro_bins, device, use_amp, num_windows
        )
