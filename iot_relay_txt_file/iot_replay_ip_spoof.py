...
class IoTIPSpoofSimulator(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]

    def __init__(self, *args, **kwargs):
        super(IoTIPSpoofSimulator, self).__init__(*args, **kwargs)
        ...
        self.logger.info("Starting IoT replay + IP spoofing simulation.")
            ...
            try:
                with open(self.csv_file, "r") as f:
                    ...
                    for row in reader:
                        ...
                        # Every attack_interval packets, send spoof attack:
