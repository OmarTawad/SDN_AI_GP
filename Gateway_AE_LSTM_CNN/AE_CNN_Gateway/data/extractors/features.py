...
DOS_WINDOW_SIZE = float(DOS_CONFIG["windowing"]["window_sec"])
DOS_WINDOW_STRIDE = float(DOS_CONFIG["windowing"]["stride_sec"])
ARP_WINDOW_SIZE = float(ARP_CONFIG["windowing"]["window_sec"])
ARP_WINDOW_STRIDE = float(ARP_CONFIG["windowing"]["stride_sec"])
